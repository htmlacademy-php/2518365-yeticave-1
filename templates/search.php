                            ...
                            <div class="lot__info">
                                ...
                                <div class="lot__state">
                                    ...
                                    <?php if (isset($lot['date_end'])):
                                        ...
                                        ?>
                                        <div
                                            class="lot__timer timer <?= (get_dt_range($lot['date_end']))[0] === '00' ? 'timer--finishing' : ''; ?>">
        ...
        <?php if ($pages_count > 1): ?>
            <ul class="pagination-list">
                <li class="pagination-item pagination-item-prev">
                    <a <?php if ($cur_page != 1): ?> href="/search.php?search=<?= $search ?>&page=<?= $cur_page - 1 ?>" <?php endif; ?>>Назад</a>
                </li>
                ...
                <li class="pagination-item pagination-item-next">
                    <a <?php if ($cur_page != $pages_count): ?> href="/search.php?search=<?= $search ?>&page=<?= $cur_page + 1 ?>" <?php endif; ?>>Вперед</a>
                </li>
            </ul>
        <?php endif; ?>
    </div>
