        ...
        <?php if ($pages_count > 1): ?>
            <ul class="pagination-list">
                <li class="pagination-item pagination-item-prev">
                    <a <?php if ($cur_page != 1): ?> href="/all-lots.php?id=<?= $id ?>&page=<?= $cur_page - 1 ?>" <?php endif; ?>>Назад</a>
                </li>
                ...
                <li class="pagination-item pagination-item-next">
                    <a <?php if ($cur_page != $pages_count): ?> href="/all-lots.php?id=<?= $id ?>&page=<?= $cur_page + 1 ?>" <?php endif; ?>>Вперед</a>
                </li>
            </ul>
        <?php endif; ?>
    </div>
