                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span
                                    class="lot-item__cost"><?= htmlspecialchars(get_price((int)$lot['start_price'] ?? 0)); ?></span>
                            </div>
                            ...
                            <form class="lot-item__form" action="lot.php?id=<?= $_GET['id'] ?>" method="post"
                                ...
                                <p class="lot-item__form-item form__item <?= $classname; ?>">
                                    ...
                                    <input id="cost" type="text" name="price"
                                           placeholder="<?= get_price((int)$lot['start_price'] + (int)$lot['bet_step'] ?? 0); ?>"
                                           value="<?= get_post_value('price'); ?>">
