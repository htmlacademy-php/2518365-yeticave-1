	...
	<form class="form form--add-lot container form--invalid" action="add.php" method="post" enctype="multipart/form-data">
	  ...
	  <div class="form__container-two">
		...
		<div class="form__item <?= $classname; ?>" >
		  ...
		  <input id="lot-name" type="text" name="name" placeholder="Введите наименование лота" value="<?= get_post_value('name'); ?>">
	  ...
	  <div class="form__item form__item--wide <?= $classname; ?>">
		...
		<textarea id="message" name="description" placeholder="Напишите описание лота" value="<?= get_post_value('description'); ?>"></textarea>
	  ...
	  <div class="form__container-three">
		...
		<div class="form__item form__item--small <?= $classname; ?>">
		  ...
		  <input id="lot-rate" type="text" name="start_price" placeholder="0" value="<?= get_post_value('start_price'); ?>">
		...
		<div class="form__item form__item--small <?= $classname; ?>">
		  ...
		  <input id="lot-step" type="text" name="bet_step" placeholder="0" value="<?= get_post_value('bet_step'); ?>">
		...
		<div class="form__item <?= $classname; ?>">
		  ...
		  <input class="form__input-date" id="lot-date" type="text" name="date_end" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= get_post_value('date_end'); ?>">
